                                   ...
                                   <xsl:element name="cds:Series" namespace="{$Namespace}">
                                        ...
                                        <xsl:for-each select="generic:Obs">
                                             <xsl:element name="cds:Obs" namespace="{$Namespace}">
                                                  ...
                                                  <xsl:attribute name="{$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:TimeDimension/@concept}"><xsl:value-of select="generic:Time"/></xsl:attribute>
                                                  </xsl:if>
                                                  <!-- Create Observation Value -->
                                                  <xsl:if test="generic:ObsValue/@value">
                                                  <xsl:attribute name="{$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:PrimaryMeasure/@concept}"><xsl:value-of select="generic:ObsValue/@value"/></xsl:attribute>
                                                  </xsl:if>
