               ...
               <xsl:when test="$KFID != 'notPassed'">
                    ...
                    <xsl:choose>
                         ...
                         <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]">
                              ...
                              <xsl:variable name="DataSetAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Attribute[@attachmentLevel='DataSet']/@concept"/>
                              ...
                              <xsl:variable name="GroupAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Attribute[structure:AttachmentGroup=$GroupID]/@concept"/>
                              <!-- Variables for Defining Series -->
                              <xsl:variable name="SeriesDims" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension/@concept"/>
                              <xsl:variable name="SeriesAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Attribute[@attachmentLevel='Series']/@concept"/>
                              <!-- Variables for Defining Observations -->
                              <xsl:variable name="ObsAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Attribute[@attachmentLevel='Observation']/@concept"/>
                              <!-- Variable for Cross Sectional Measures -->
                              <xsl:variable name="XSMeas" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure/@concept"/>
                                                       ...
                                                       <xsl:for-each select="$Observations">
                                                            ...
                                                            <xsl:variable name="UniqueGroup">
                                                                 ...
                                                                 <xsl:for-each select="$GroupDims">
                                                                      ...
                                                                      <xsl:choose>
                                                                           <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$GroupDim]/@isMeasureDimension='true'">
                                                                           ...
                                                                           <xsl:otherwise>
                                                                                ...
                                                                                <xsl:choose>
                                                                                     <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$GroupDim]/@crossSectionalAttachGroup='true'">
                                                                                     ...
                                                                                     <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$GroupDim]/@crossSectionalAttachSection='true'">
                                                                                          <xsl:variable name="PriorDimValue" select="$Section/preceding::*[local-name()='Section'][@*[name()=$GroupDim]=$DimValue]"/>
                                                                                          <xsl:if test="not($PriorDimValue)">X</xsl:if>
                                                                                     </xsl:when>
                                                                                     <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$GroupDim]/@crossSectionalAttachObservation='true'">
                                                                      ...
                                                                      <xsl:element name="generic:GroupKey">
                                                                           <xsl:for-each select="$GroupDims">
                                                                                <xsl:element name="generic:Value">
                                                                                     ...
                                                                                     <xsl:choose>
                                                                                          <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$GroupDim]/@isMeasureDimension='true'">
                                                                                               <xsl:variable name="XSM" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure[@concept=local-name($Obs)]"/>
                                                                                     ...
                                                                                     <xsl:if test="$GroupKey = $GroupKeyTest2">
                                                                                          <xsl:variable name="UniqueSeries">
                                                                                               ...
                                                                                               <xsl:for-each select="$SeriesDims">
                                                                                                    ...
                                                                                                    <xsl:choose>
                                                                                                         <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@isMeasureDimension='true'">
                                                                                                         ...
                                                                                                         <xsl:otherwise>
                                                                                                              ...
                                                                                                              <xsl:choose>
                                                                                                                   <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@crossSectionalAttachGroup='true'">
                                                                                                                        <xsl:variable name="PriorDimValue" select="$SGroup/preceding::*[local-name()='Group'][@*[name()=$SeriesDim]=$DimValue]"/>
                                                                                                                        <xsl:if test="not($PriorDimValue)">X</xsl:if>
                                                                                                                   </xsl:when>
                                                                                                                   <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@isFrequencyDimension='true'">
                                                                                                                        <xsl:variable name="PriorDimValue" select="$SGroup/preceding::*[local-name()='Group'][@*[name()=$SeriesDim]=$DimValue]"/>
                                                                                                                        <xsl:if test="not($PriorDimValue)">X</xsl:if>
                                                                                                                   </xsl:when>
                                                                                                                   <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@crossSectionalAttachSection='true'">
                                                                                                                        <xsl:variable name="PriorDimValue" select="$SSection/preceding::*[local-name()='Section'][@*[name()=$SeriesDim]=$DimValue]"/>
                                                                                                                        <xsl:if test="not($PriorDimValue)">X</xsl:if>
                                                                                                                   </xsl:when>
                                                                                                                   <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@crossSectionalAttachObservation='true'">
                                                                                          ...
                                                                                          <xsl:if test="$UniqueSeries!=''">
                                                                                               ...
                                                                                               <xsl:element name="generic:Series">
                                                                                                    ...
                                                                                                    <xsl:element name="generic:SeriesKey">
                                                                                                         <xsl:for-each select="$SeriesDims">
                                                                                                              <xsl:element name="generic:Value">
                                                                                                                   ...
                                                                                                                   <xsl:choose>
                                                                                                                        <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@concept=$SeriesDim]/@isMeasureDimension='true'">
                                                                                                                             <xsl:variable name="XSM" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure[@concept=local-name($SObs)]"/>
                                                                                                                             <xsl:attribute name="concept"><xsl:value-of select="$XSM/@measureDimension"/></xsl:attribute>
                                                                                                                             <xsl:attribute name="value"><xsl:value-of select="$XSM/@code"/></xsl:attribute>
                                                                                                                        </xsl:when>
                                                                                                                        <xsl:otherwise>
                                                                                                    ...
                                                                                                    <xsl:for-each select="$GroupObservations[position()>=$GroupPos]">
                                                                                                         <xsl:sort select="ancestor::*[local-name()='Group']/@time"/>
                                                                                                         ...
                                                                                                         <xsl:if test="(($SeriesKey = $SeriesKeyTest) and ($GroupKey = $GroupKeyTest3))">
                                                                                                              <xsl:if test="$MSObs/ancestor::*[local-name()='Group']/@time">
                                                                                                                   <!-- Create Observation Element -->
                                                                                                                   <xsl:element name="generic:Obs">
                                                                                                                        <!-- Create Time Element -->
                                                                                                                        <xsl:element name="generic:Time">
                                                                                                                             <xsl:value-of select="ancestor::*[local-name()='Group']/@time"/>
                                                                                                                        </xsl:element>
