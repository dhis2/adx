...
exclude-result-prefixes="message xsl structure compact"
version="1.0" >
     <!-- Reusable Stylesheet to copy header info, without unnecessary namespaces -->
     <xsl:include href="HeaderCopy.xslt"/>
                              ...
                              <GenericData>
                                   ...
                                   <xsl:for-each select="/message:CompactData/*[local-name()='DataSet']">
                                        <xsl:element name="DataSet">
                                             ...
                                             <xsl:if test="@*[local-name() = $DataSetAtts/@conceptRef]">
                                                  <xsl:element name="generic:Attributes">
                                                       <xsl:for-each select="@*[local-name() = $DataSetAtts/@conceptRef]">
                                             ...
                                             <xsl:for-each select="*[local-name() != 'Series' and local-name() != 'Annotations']">
                                                  ...
                                                  <xsl:element name="generic:Group">
                                                       ...
                                                       <xsl:if test="@*[local-name() = $GroupAtts/@conceptRef]">
                                                            <xsl:element name="generic:Attributes">
                                                                 <xsl:for-each select="@*[local-name() = $GroupAtts/@conceptRef]">
                                                                      <xsl:element name="generic:Value">
                                                                           <xsl:attribute name="concept"><xsl:value-of select="local-name(.)"/></xsl:attribute>
                                                                           <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                      </xsl:element>
                                                            ...
                                                            <xsl:if test="$GKT = $SKT">
                                                                 ...
                                                                 <xsl:element name="generic:Series">
                                                                      ...
                                                                      <xsl:element name="generic:SeriesKey">
                                                                           <xsl:for-each select="@*[local-name() = $SeriesKey/@conceptRef]">
                                                                                <xsl:element name="generic:Value">
                                                                                     <xsl:attribute name="concept"><xsl:value-of select="local-name(.)"/></xsl:attribute>
                                                                                     <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                                </xsl:element>
                                                                      ...
                                                                      <xsl:if test="@*[local-name() = $SeriesAtts/@conceptRef]">
                                                                           <xsl:element name="generic:Attributes">
                                                                                <xsl:for-each select="@*[local-name() = $SeriesAtts/@conceptRef]">
                                                                                     <xsl:element name="generic:Value">
                                                                                          <xsl:attribute name="concept"><xsl:value-of select="local-name(.)"/></xsl:attribute>
                                                                                          <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                                     </xsl:element>
                                                                      ...
                                                                      <xsl:for-each select="*[local-name()='Obs']">
                                                                           <xsl:element name="generic:Obs">
                                                                                ...
                                                                                <xsl:for-each select="@*[local-name()=$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:TimeDimension/@conceptRef]">
                                                                                ...
                                                                                <xsl:for-each select="@*[local-name()=$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:PrimaryMeasure/@conceptRef]">
                                                                                ...
                                                                                <xsl:if test="@*[local-name() = $ObsAtts/@conceptRef]">
                                                                                     <xsl:element name="generic:Attributes">
                                                                                          <xsl:for-each select="@*[local-name() = $ObsAtts/@conceptRef]">
                                                                                               <xsl:element name="generic:Value">
                                                                                                    <xsl:attribute name="concept"><xsl:value-of select="local-name(.)"/></xsl:attribute>
                                                                                                    <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                                               </xsl:element>
