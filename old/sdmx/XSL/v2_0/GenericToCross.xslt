               ...
               <xsl:when test="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]">
                    ...
                    <CrossSectionalData>
                         ...
                         <xsl:element name="csds:DataSet" namespace="{$Namespace}">
                              ...
                              <xsl:variable name="DataSetDims" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Dimension[@crossSectionalAttachDataSet = 'true']/@conceptRef"/>
										 <xsl:variable name="TimeDim" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:TimeDimension"/>
                              <xsl:variable name="DataSetAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Attribute[@crossSectionalAttachDataSet = 'true']/@conceptRef"/>
                              <!-- Variables for Defining Cross Sectional Groups -->
                              <xsl:variable name="GroupDims" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Dimension[@isFrequencyDimension = 'true' or @crossSectionalAttachGroup = 'true']/@conceptRef"/>
                              <xsl:variable name="GroupAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Attribute[@crossSectionalAttachGroup = 'true']/@conceptRef"/>
                              <!-- Variables for Defining Cross Sectional Sections -->
                              <xsl:variable name="SectDims" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Dimension[@crossSectionalAttachSection = 'true']/@conceptRef"/>
                              <xsl:variable name="SectAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Attribute[@crossSectionalAttachSection = 'true']/@conceptRef"/>
                              <!-- Variables for Defining Cross Sectional Observations -->
                              <xsl:variable name="ObsDims" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Dimension[@crossSectionalAttachObservation = 'true']/@conceptRef"/>
                              <xsl:variable name="ObsAtts" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]/structure:Components/structure:Attribute[@crossSectionalAttachObservation = 'true']/@conceptRef"/>
                                   ...
                                   <xsl:if test="$UniqueGroup != ''">
                                        ...
                                        <xsl:element name="csds:Group" namespace="{$Namespace}">
                                             ...
                                             <xsl:if test="generic:Time">
                                             		 <xsl:if test="$TimeDim/@crossSectionalAttachGroup='true'">
                                             		 	<xsl:attribute name="{$TimeDim/@conceptRef}"><xsl:value-of select="generic:Time"/></xsl:attribute>
                                             		 </xsl:if>
                                             </xsl:if>
                                        ...
                                        <xsl:variable name="Time" select="generic:Time"/>
                                        <!-- Check that no other Observation has the same Time value-->
                                        <xsl:variable name="PriorTime" select="$SObs/preceding::generic:Obs/generic:Time[. = $Time]"/>
                                        <!-- If another Observaton has the same Time value, the variable will have content -->
                                        <xsl:if test="not($PriorTime)">X</xsl:if>   
                                                                 </xsl:variable>
                                             		 ...
                                             		 <xsl:if test="$TimeDim/@crossSectionalAttachSeries='true'">
                                             		 	<xsl:attribute name="{$TimeDim/@conceptRef}"><xsl:value-of select="generic:Time"/></xsl:attribute>
                                             		 </xsl:if>
                                                                           ...
                                                                           <xsl:for-each select="$GroupObservation[position() >= $GroupPos]">
                                                                                ...
                                                                                <xsl:if test="(($SectKey = $SectKeyTest) and ($GroupKey = $GroupKeyTest3))">
                                                                                     ...
                                                                                     <xsl:for-each select="$CSMeasures">
                                                                                          ...
                                                                                          <xsl:variable name="CSName" select="@conceptRef"/>
                                             		 ...
                                             		 <xsl:if test="$TimeDim/@crossSectionalAttachObservation='true'">
                                             		 	<xsl:attribute name="{$TimeDim/@conceptRef}"><xsl:value-of select="generic:Time"/></xsl:attribute>
                                             		 </xsl:if>
