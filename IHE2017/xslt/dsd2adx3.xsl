...
<!-- ===============================================================================
    ...
    <xsl:key name="categoryCombos" 
        match="str:Codelist[@id='CL_DataElements']/str:Code/@id" 
        use="com:Annotations/com:Annotation[@id='Disaggregation']/com:AnnotationText/text()"/>
