<?xml version="1.0"?>
<!-- Pass in parameter for target namespace -DONE -->
<!-- Pass in parameter for position of KeyFamily element (or match on KF id?)-->
<!-- Deal with text-format attributes! -DONE (excpet NumFixed) -->
<!-- Check that none of the codelist attributes are dropped -->
<!--  Make sure that annotations in KF codelists transfer into schema (does this make sense? I don't think so...) -->
<xsl:stylesheet 
		...
		<xsl:variable name="KFID">
          ...
          <xs:schema>
               ...
               <xsl:element name="xs:import">
                    <xsl:attribute name="namespace"><xsl:text>http://www.SDMX.org/resources/SDMXML/schemas/v1_0/utility</xsl:text></xsl:attribute>
               ...
               <xsl:element name="xs:element">
                    ...
                    <xsl:attribute name="substitutionGroup"><xsl:text>utility:DataSet</xsl:text></xsl:attribute>
               </xsl:element>
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              <xsl:attribute name="base"><xsl:text>utility:DataSetType</xsl:text></xsl:attribute>
                              <xsl:element name="xs:sequence">
                                   <xsl:element name="xs:choice">
                                        ...
                                        <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components">
                                             <xsl:choose>
                                   ...
                                   <xsl:element name="xs:attribute">
                                        ...
                                        <xsl:attribute name="use">
                                             ...
                                             <xsl:if test="@assignmentStatus='Conditional'">
                                                  <xsl:text>optional</xsl:text></xsl:if>
                                             </xsl:attribute>
                                   </xsl:element>
               ...
               <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Group">
                    <xsl:element name="xs:element">
                         ...
                         <xsl:attribute name="substitutionGroup"><xsl:text>utility:Group</xsl:text></xsl:attribute>
               ...
               <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Group">
                    <xsl:element name="xs:complexType">
                         ...
                         <xsl:element name="xs:complexContent">
                              <xsl:element name="xs:extension">
                                   <xsl:attribute name="base"><xsl:text>utility:GroupType</xsl:text></xsl:attribute>
                                   <xsl:element name="xs:sequence">
                                        <xsl:element name="xs:element">
               ...
               <xsl:element name="xs:element">
                    <xsl:attribute name="name"><xsl:text>Series</xsl:text></xsl:attribute>
                    <xsl:attribute name="substitutionGroup"><xsl:text>utility:Series</xsl:text></xsl:attribute>
                    <xsl:attribute name="type"><xsl:text>SeriesType</xsl:text></xsl:attribute>
               </xsl:element>
               <!-- End Series Element -->
               <!-- Series Complex Type -->
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              <xsl:attribute name="base"><xsl:text>utility:SeriesType</xsl:text></xsl:attribute>
                              <xsl:element name="xs:sequence">
                                   <xsl:element name="xs:element">
                                        <xsl:attribute name="ref"><xsl:text>Key</xsl:text></xsl:attribute>
                                   </xsl:element>
               ...
               <!-- Key Element -->
               <xsl:element name="xs:element">
                    <xsl:attribute name="name"><xsl:text>Key</xsl:text></xsl:attribute>
                    <xsl:attribute name="substitutionGroup"><xsl:text>utility:Key</xsl:text></xsl:attribute>
                    <xsl:attribute name="type"><xsl:text>KeyType</xsl:text></xsl:attribute>
               </xsl:element>
               <!-- End Key Element -->
               <!-- Key Complex Type -->
               <xsl:element name="xs:complexType">
                    <xsl:attribute name="name"><xsl:text>KeyType</xsl:text></xsl:attribute>
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              <xsl:attribute name="base"><xsl:text>utility:KeyType</xsl:text></xsl:attribute>
                              <xsl:element name="xs:sequence">
               ...
               <xsl:element name="xs:element">
                    ...
                    <xsl:attribute name="substitutionGroup"><xsl:text>utility:Obs</xsl:text></xsl:attribute>
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              <xsl:attribute name="base"><xsl:text>utility:ObsType</xsl:text></xsl:attribute>
                              <xsl:element name="xs:sequence">
                                   <xsl:element name="xs:element">
