		...
		<xsl:variable name="KFID">
          ...
          <xs:schema>
               ...
               <xsl:element name="xs:import">
                    <xsl:attribute name="namespace"><xsl:text>http://www.SDMX.org/resources/SDMXML/schemas/v1_0/cross</xsl:text></xsl:attribute>
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              ...
                              <!--Close xs:choice-->
                              <xsl:for-each select="message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/*[@crossSectionalAttachDataSet='true']">
               ...
               <xsl:element name="xs:complexType">
                    ...
                    <xsl:element name="xs:complexContent">
                         <xsl:element name="xs:extension">
                              ...
                              <!--Close xs:sequence-->
                              <!-- Group Attriubtes -->
                              <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/*[@crossSectionalAttachGroup='true' or @isFrequencyDimension='true']">
                                   <xsl:element name="xs:attribute">
                                        <xsl:attribute name="name"><xsl:value-of select="@concept"/></xsl:attribute>
                                        <xsl:attribute name="type">
                                             <xsl:if test="@codelist">
                         ...
                         <xsl:element name="xs:extension">
                              ...
                              <xsl:element name="xs:choice">
                                   ...
                                   <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure">
                                        <xsl:element name="xs:element">
                                             <xsl:attribute name="ref"><xsl:value-of select="@concept"/></xsl:attribute>
                                        </xsl:element>
                              ...
                              <!--Close xs:choice-->
                              <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/*[@crossSectionalAttachSection='true']">
                                   <xsl:element name="xs:attribute">
                                        <xsl:attribute name="name"><xsl:value-of select="@concept"/></xsl:attribute>
                                        <xsl:attribute name="type">
                                             <xsl:if test="@codelist">
               ...
               <xsl:choose>
                    <xsl:when test="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure">
                         <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:CrossSectionalMeasure">
                              <xsl:variable name="CSM" select="@concept"/>
                              <!-- Cross Sectional Measure Element -->
                              <xsl:element name="xs:element">
                                   <xsl:attribute name="name"><xsl:value-of select="@concept"/></xsl:attribute>
                                   <xsl:attribute name="substitutionGroup"><xsl:text>cross:Obs</xsl:text></xsl:attribute>
                                   <xsl:attribute name="type"><xsl:value-of select="@concept"/><xsl:text>Type</xsl:text></xsl:attribute>
                              </xsl:element>
                              <!--Close xs:element (CrossSectionalMeasure)-->
                              ...
                              <xsl:element name="xs:complexType">
                                   ...
                                   <xsl:element name="xs:complexContent">
                                        <xsl:element name="xs:extension">
                                             ...
                                             <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Dimension[@crossSectionalAttachObservation='true']">
                                                  <xsl:element name="xs:attribute">
                                                       <xsl:attribute name="name"><xsl:value-of select="@concept"/></xsl:attribute>
                                             ...
                                             <xsl:for-each select="/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:Attribute[@crossSectionalAttachObservation='true' and structure:AttachmentMeasure = $CSM]">
                                                  <xsl:element name="xs:attribute">
                                                       <xsl:attribute name="name"><xsl:value-of select="@concept"/></xsl:attribute>
                                                       <xsl:attribute name="type">
                                                            <xsl:if test="@codelist">
