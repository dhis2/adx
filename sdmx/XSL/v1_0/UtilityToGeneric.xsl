                    ...
                    <xsl:for-each select="*[local-name() = 'Obs']">
                         <xsl:element name="generic:Obs">
                              ...
                              <xsl:variable name="TimeDim">
                                   <xsl:value-of select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:TimeDimension/@concept"/>
                              </xsl:variable>
                              ...
                              <xsl:variable name="Measure">
                                   <xsl:value-of select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KFID]/structure:Components/structure:PrimaryMeasure/@concept"/>
                              </xsl:variable>
