     ...
     <xsl:template match="/">
          ...
          <xsl:choose>
			...
			<xsl:variable name="KeyFam" select="$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=$KeyFamID]"/>
                    ...
                    <UtilityData>
                         <!-- If Saxon is used, copy the Utility namespace declaration to the root element - cosmetic only -->
	                                        ...
	                                        <xsl:element name="uds:{$GroupID}" namespace="{$Namespace}">
	                                             ...
	                                             <xsl:for-each select="generic:Series">
	                                                  ...
	                                                  <xsl:element name="uds:Series" namespace="{$Namespace}">
	                                                       ...
	                                                       <xsl:element name="uds:Key" namespace="{$Namespace}">
		                                                       <xsl:for-each select="$Dim">
		                                                       	<xsl:variable name="DimID" select="@conceptRef"/>
	                                                       ...
	                                                       <xsl:for-each select="generic:Obs">
	                                                            <xsl:element name="uds:Obs" namespace="{$Namespace}">
	                                                                 ...
	                                                                 <xsl:element name="uds:{$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=	$KeyFamID]/structure:Components/structure:TimeDimension/@conceptRef}" namespace="{$Namespace}">
													...
													<xsl:otherwise>NaN</xsl:otherwise>
	                                                                 ...
	                                                                 <xsl:element name="uds:{$Structure/message:Structure/message:KeyFamilies/structure:KeyFamily[@id=	$KeyFamID]/structure:Components/structure:PrimaryMeasure/@conceptRef}" namespace="{$Namespace}">
